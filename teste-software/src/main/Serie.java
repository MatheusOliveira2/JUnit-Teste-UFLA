...
public class Serie {
	...
	public static void main(String[] args) {
		...
		System.out.println("Digite o nmero de incio da sequncia: ");
		...
		System.out.println("Digite o nmero final da sequncia: ");
		while (!read.hasNextFloat()) {
			System.out.println("A entrada deve ser um nmero. Tente novamente: ");
			read.next();
		}
		...
		System.out.println("Digite o nmero de stepsize: ");
		step = read.nextFloat();
